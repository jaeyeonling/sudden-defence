...
export class AmmoPanel {
  ...
  /**
   * Hide the whole panel. Used while the local player is dead: a magazine
   * count and a PRESS R TO RELOAD prompt belong to a gun somebody is holding,
   * and a spectator is not holding one. Observed on a real death frame — the
   * corpse was being told to reload.
   */
  setVisible(v) {
