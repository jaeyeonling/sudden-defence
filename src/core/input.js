 ...
 *
 * `Tab` is the scoreboard and nothing else: it is the key a player holds for a
 * second in the middle of a live round, so it must not also cycle a weapon.
 * Weapon selection is by number, the way round-based shooters do it.
 */
