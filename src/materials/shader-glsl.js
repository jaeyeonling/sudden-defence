/**
 * The injected GLSL. Kept apart from the patching API in `shader.js` because
 * this file is one long string constant per chunk and that is all it is.
 */
...
export const PARS_FRAGMENT = /* glsl */ `
varying vec3 vOwWPos;
varying vec3 vOwWNrm;
#ifdef OW_OBJECT_SPACE
  varying vec3 vOwOPos;
...
export const MAIN_FRAGMENT = /* glsl */ `
{
